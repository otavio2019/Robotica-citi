...
describe('regras do cadastro TJR', () => {
  ...
  it('rejeita idade acima de 19', () => expect(() => validateRegistration({ ...validPayload, competitors: validPayload.competitors.map((member, i) => i === 0 ? { ...member, birthDate: '2000-01-01' } : member) }, 4)).toThrow('até 19'));
});
